...
### Not random: tied to relationships in the field
...
- **Anxiety**
  ...
  - “Given how I’m organising myself + this situation + the future,  
    there is no move that feels safe or acceptable.”

- **Shame**

  - “Given my current self-story and moral frame,  
    this event reads as _‘I am fundamentally not okay’_.”

- **Anger**

  - “Given my current values and sense of self,  
    something in this pattern reads as _intolerably wrong_,  
    and energy is mobilised to redraw a boundary or change the pattern.”

- **Numbness**
  - “Given the amount of pain / contradiction / overload in the current configuration,  
    it feels safer to turn down detail and contact.”

You don’t have to agree with these characterisations.  
They’re just invitations to look at what your own difficult feelings _seem to be about_.
...
That doesn’t mean you _like_ it.  
